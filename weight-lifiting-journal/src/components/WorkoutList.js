...
const WorkoutList = props => {
  ...
  (props.userData &&
    console.log("outside of the useEffect", props.userData.username)) ||
    console.log("work");
  ...
  return (
    <div>
      ...
      {props.userData.workouts &&
        props.userData.workouts.map(work => (
          <button onClick={() => props.history.push(`/workout/${work.id}`)}>
            {work.workout_name}
          </button>
        ))}
    </div>
