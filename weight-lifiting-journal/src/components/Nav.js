    ...
    return(
        ...
        <NavDiv>
            <Center>
                ...
                <LinkDiv>
                    <NavLink className='link box' to='/'>Home</NavLink>
                    <NavLink className='link box' to='/sign-up'>Sign Up</NavLink>
                    <NavLink className='link box real' to='/login' >Sign In</NavLink>
